...
export async function generateMetadata() {
  return {
    title: 'JLPT N3 Vocabulary Guide - Intermediate Japanese | KanaDojo',
    description:
    ...
    <div className='mx-auto max-w-4xl px-4 py-8'>
      ...
      <div className='space-y-8 text-[var(--secondary-color)]'>
        ...
        <section className='rounded-lg border-2 border-[var(--border-color)] bg-[var(--card-color)] p-6'>
          ...
          <p className='mb-4'>
            JLPT N3 is the intermediate level, bridging elementary and advanced
            Japanese. It tests your ability to understand Japanese used in
        ...
        <section>
          ...
          <div className='space-y-4'>
            <div className='rounded-lg bg-[var(--card-color)] p-4'>
              ...
              <p>
                Many N3 vocabulary words are compounds of N4/N5 kanji. Learning
        ...
        <section className='rounded-lg border-2 border-[var(--main-color)] bg-[var(--card-color)] p-6'>
          ...
          <div className='space-y-3'>
            ...
            <div>
              ...
              <p className='text-sm'>
                N3 introduces more formal vocabulary. Understanding register is
                crucial.
              </p>
            </div>
            <div>
