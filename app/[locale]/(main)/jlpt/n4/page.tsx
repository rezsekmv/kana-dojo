...
export async function generateMetadata() {
  return {
    title: 'JLPT N4 Kanji List - Complete Study Resource | KanaDojo',
    description:
    ...
    <div className='mx-auto max-w-4xl px-4 py-8'>
      ...
      <div className='space-y-8 text-[var(--secondary-color)]'>
        ...
        <section className='rounded-lg border-2 border-[var(--border-color)] bg-[var(--card-color)] p-6'>
          ...
          <p className='mb-4'>
            JLPT N4 is the elementary level, testing your ability to understand
            basic Japanese in everyday situations.
          </p>
        ...
        <section>
          ...
          <div className='space-y-4'>
            ...
            <div className='rounded-lg bg-[var(--card-color)] p-4'>
              ...
              <p>
                Vary your practice with Pick, Input, and Blitz modes for better
                retention.
              </p>
            </div>
          </div>
        ...
        <section className='rounded-lg border-2 border-[var(--main-color)] bg-[var(--card-color)] p-6'>
          ...
          <ul className='mb-4 list-disc space-y-2 pl-6'>
            <li>See which kanji you&apos;ve mastered vs need more practice</li>
