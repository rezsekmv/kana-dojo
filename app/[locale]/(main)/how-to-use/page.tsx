      ...
      <div className='space-y-8 text-[var(--secondary-color)]'>
        ...
        <section>
          ...
          <div className='space-y-3'>
            ...
            <div className='rounded-lg border-2 border-[var(--border-color)] bg-[var(--card-color)] p-4'>
              ...
              <p>
                Type the romanization of the displayed character. Builds active
            ...
            <div className='rounded-lg border-2 border-[var(--border-color)] bg-[var(--card-color)] p-4'>
              ...
              <p>
                Timed challenges to test speed and accuracy. Great for building
        ...
        <section>
          ...
          <ul className='list-disc space-y-2 pl-6'>
            <li>
              <strong>Accuracy per character</strong> - See which characters you
              struggle with
            </li>
            <li>
              <strong>Speed metrics</strong> - Track your improvement over time
            </li>
            <li>
              <strong>Study streaks</strong> - Build consistent learning habits
            </li>
            <li>
          ...
          <p className='mt-4'>
            All data is stored locally in your browser - no account needed, and
        ...
        <section>
          ...
          <div className='space-y-3'>
            ...
            <div className='rounded-lg border-l-4 border-[var(--main-color)] bg-[var(--card-color)] p-4'>
              ...
              <p>
                Use different modes to reinforce learning from multiple angles.
              </p>
            </div>
        ...
        <section>
          ...
          <div className='space-y-4'>
            ...
            <div>
              ...
              <p>
                Yes! KanaDojo works as a Progressive Web App (PWA). Once loaded,
                it works offline.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                This depends on your goals and study time. Most learners master
                Hiragana and Katakana within a month, and can be ready for JLPT
                N5 within 3-6 months of consistent study.
              </p>
            </div>
          </div>
        </section>
